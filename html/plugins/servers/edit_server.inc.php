...
if (!isset($id) || empty($id) || !is_numeric($id)) {
  ...
  $select_html = "<select class='form-control custom col-lg-12 col-md-7 col-xs-12' name='distro_ver_id'>";

  $server_group_map_sql = "SELECT * FROM server_group;";
  $server_group_map_res = mysql_query($server_group_map_sql);

  $select_html_sg = "<select class='form-control custom col-lg-12 col-md-7 col-xs-12' name='server_group'>";
  ...
  <div class="col-sm-12 col-md-5 col-xs-12 main">
    <div class="x_panel">
      ...
      <form id ="editUser" method="POST" action="<?php echo BASE_PATH; ?>plugins/servers/p_edit_server.inc.php">
        <input type="hidden" name="id" value="<?php print $id; ?>" />
        <div class="form-group">
          <label class="control-label col-lg-12 col-md-4 col-sm-4 col-xs-12">Last Seen</label>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <input type="text" value="<?php echo $last_seen; ?>" class="form-control col-lg-12 col-md-7 col-xs-12" readonly />
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-12 col-md-4 col-sm-4 col-xs-12">Last Checked for updates</label>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <input type="text" name="last_checkin" value="<?php echo $last_check; ?>" class="form-control col-lg-12 col-md-7 col-xs-12" readonly />
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-12 col-md-4 col-sm-4 col-xs-12">Server Name</label>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <input value="<?php echo $server_name; ?>" type="text" name="server_name" class="form-control col-lg-12 col-md-7 col-xs-12" placeholder="Server Name" required autofocus >
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-12 col-md-4 col-sm-4 col-xs-12">Server Alias</label>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <input value="<?php echo $server_alias; ?>" type="text" name="server_alias" class="form-control col-lg-12 col-md-7 col-xs-12" placeholder="Server Alias" required autofocus >
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label class="control-label col-lg-12 col-md-4 col-sm-4 col-xs-12">IP Address</label>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <input type="text" name="server_ip" value="<?php echo $server_ip; ?>" class="form-control col-lg-12 col-md-7 col-xs-12" placeholder="IP Address" />
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-12 col-md-4 col-sm-4 col-xs-12">Check Interval (Hours)</label>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <input value="<?php echo $check_interval; ?>" type="number" name="check_interval" class="form-control col-lg-12 col-md-7 col-xs-12" placeholder="2" required autofocus >
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-12 col-md-4 col-sm-4 col-xs-12">Distro</label>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <?php echo $select_html;?>
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-12 col-md-4 col-sm-4 col-xs-12">Trusted?</label>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <input type="checkbox" name="trusted" class="checkbox flat col-lg-12 col-md-7 col-xs-12" <?php echo $trusted_checked; ?>>
          </div>
        </div>
        <div class="form-group">
          <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3">
            <button class="btn btn-md btn-success btn-block" type="submit">Edit Server</button>
          </div>
        </div>
      </form>
    </div>
