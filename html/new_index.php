...
#    $allowed_pages[] = "admin";
    $admin_plugins_sql = "SELECT pm.page_name as name, p.name as plugin_name FROM page_maps pm LEFT JOIN plugins p ON pm.plugin_parent = p.id where p.installed = 1 and p.disabled = 0 and p.is_admin=1";
...
exit();
    ...
    if (mysql_num_rows($url_res) == 0){
        ...
        include 'inc/navbar.inc.php';
        include "$plugin_dir/${final_plugin}/$file";
